	...
	async execute(client) {
		...
		function sendTicketMSG() {
			...
			const embed = new EmbedBuilder()
			  ...
			  .setDescription('**Destek talebi açmak için butona basın.**\n \n**Destek Talebi oluşturduktan sonra sorununuzu seçin ve yetkilileri bekleyin.**\n \n **Gereksiz/Troll/Sürekli etiket atan üyeler cezalandırılır.**')
			  .setFooter({text: `${settings.sunucu.isim} Destek Talebi`, iconURL: client.user.displayAvatarURL()})
			  .setImage('https://cdn.discordapp.com/attachments/1247108972624871466/1248217529000792145/porsukbanner.png');
